...
const Markets = () => {
  ...
  return (
    <div className="min-h-dvh bg-background" style={{ paddingBottom: 'var(--safe-area-bottom)' }}>
      <AppHeader />
      <main className="container max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">{t("page_title")}</h1>
