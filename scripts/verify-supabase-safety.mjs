...
const guard = readFileSync(
  join(root, "supabase/migrations/00000000000000_DO_NOT_REPLAY_LEGACY.sql"),
  "utf8",
);
...
console.log(
  `Verified ${directories.size} Edge Function directories, explicit config/registry coverage, and legacy replay guard.`,
);
